...
Better Auth invokes the email provider for these flows:
...
| **Existing account** | Sign-up with already-registered email | Notifies the existing user instead of creating a duplicate account |
